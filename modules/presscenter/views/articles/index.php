...
$this->params['breadcrumbs'][] = ['label' => $this->title, 'template' =>
    "<li class='breadcrumbs-i' itemtype = 'http://schema.org/ListItem'><span class='breadcrumbs-title' itemprop = 'name'>{link}</span></li>"];
?>
...
<?= $this->render('@app/views/layouts/inc/breadcrumbs'); ?>
    ...
    <div class="container-fluid news-preview-block margin-top-0 articles-preview-block">
        <div class="container">
            <div class="col-lg-12 news-preview">
                ...
                <?= \yii\widgets\ListView::widget([
                    ...
                    'itemView' => function($model, $key, $index, $widget){
                        $imageModel = new \app\models\ImageUpload(\app\models\Articles::tableName());
                        $image = $imageModel->getImage($model, Yii::$app->params['imagePresets']['articles']['small'], 'view', 'image');
