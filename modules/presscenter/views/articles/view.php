<?php
    ...
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Статьи'), 'url' => '/presscenter/articles'];
    $this->params['breadcrumbs'][] = ['label' => $model->title, 'template' => "<li class='breadcrumbs-i' itemtype = 'http://schema.org/ListItem'>
...
<div class="container-fluid page-title-block margin-top-0 margin-bottom-0">
    ...
    <div class="container-fluid page-title-content">
        <div class="container">
            ...
            <h1 class="h1 page-title"><?= Yii::t('app', 'Статьи')?></h1>
...
<div class="container page-name-block margin-top-0 margin-bottom-0">
    <h2 class="h2"><?= Yii::t('app', 'Статьи') ?></h2>
</div>

<div class="container-fluid current-news-block articles-preview-block margin-top-0">
    <div class="container controls">
        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 controls-holder">
            <?= \kartik\helpers\Html::a(Yii::t('app', 'Смотреть предыдущую статью'), \yii\helpers\Url::to(["/$city/presscenter/articles/" . \app\models\Articles::getNextOrPrevId($model->id, 'prev')]), ['class' => 'control-btn prev'])?>
        </div>
        <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 controls-holder">
            <?= \kartik\helpers\Html::a(Yii::t('app', 'Смотреть следующую статью'), \yii\helpers\Url::to(["/$city/presscenter/articles/" . \app\models\Articles::getNextOrPrevId($model->id, 'next')]), ['class' => 'control-btn next'])?>
        </div>
    </div>
    ...
    <div class="col-lg-12 link-holder">
        <?= \kartik\helpers\Html::a(Yii::t('app', 'Вернуться на страницу пресс-центра') . '<i class="i-holder read-more-i"></i>', \yii\helpers\Url::to(["/$city/presscenter"]), ['class' => 'to-news-page-link']);?>
    </div>
</div>
