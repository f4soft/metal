<?php
    ...
    $this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Новости'), 'url' => '/presscenter/news'];
...
<div class="container-fluid page-title-block margin-top-0 margin-bottom-0">
    ...
    <div class="container-fluid page-title-content">
        <div class="container">
            ...
            <h1 class="h1 page-title"><?= Yii::t('app', 'Новости') ?></h1>
            <h5 class="h5 page-sub-title"><span><i class="i-holder prev"></i>
                    <?= Yii::t('app', 'Самый большой выбор металлопроката')?><i class="i-holder next"></i></span></h5>
        </div>
    </div>
</div>
...
<div class="container-fluid current-news-block margin-top-0">
    <div class="container controls">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 controls-holder">
            <?= \kartik\helpers\Html::a(Yii::t('app', 'Смотреть предыдущую новость'),
                \yii\helpers\Url::to(["/$city/presscenter/news/" . \app\models\News::getNextOrPrevId($model->id, 'prev')]),
                ['class' => 'control-btn prev'])?>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 controls-holder">
            <?= \kartik\helpers\Html::a(Yii::t('app', 'Смотреть следующую новость'),
                \yii\helpers\Url::to(["/$city/presscenter/news/" . \app\models\News::getNextOrPrevId($model->id, 'next')]),
    ...
    <div class="col-lg-12 link-holder">
        <?= \kartik\helpers\Html::a(Yii::t('app', 'Вернуться на страницу новостей') . '<i class="i-holder read-more-i"></i>', \yii\helpers\Url::to(["/$city/presscenter/news"]), ['class' => 'to-news-page-link']);?>
    </div>
</div>
